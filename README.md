...
Determine whether an online comment is toxic using data from 160,000 posts. Includes comparison between shallow and deep learning methods for binary classification formulation, and exploration of deep learning methods for multilabel, multiclass formulation. Both shallow and deep learning approaches achieved 85% recall on validation data.
